...
class Data:
	...
	listUnexpectedChars = []    # list of chars, that we do not expect to appear in constructions or couldn't recognise
	...
	def show_unexpected_chars(self):
